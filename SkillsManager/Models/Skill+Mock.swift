...
extension Skill {
    static let mockSkills: [Skill] = [
        Skill(
            ...
            name: "commit",
            displayName: "Commit",
            baseDescription: "Create well-formatted git commits with conventional commit messages and co-author attribution.",
        ...
        Skill(
            ...
            name: "done",
            displayName: "Done",
            baseDescription: "Save session summary with decisions, discoveries, and next steps to a markdown file.",
            baseDescriptionLocale: "en",
            localizedDescription: nil,
            source: .local,
            version: "1.0.0",
        ...
        Skill(
            ...
            baseDescription: "Write, review, or improve SwiftUI code for iOS/macOS with modern APIs and best practices.",
            baseDescriptionLocale: "en",
            localizedDescription: nil,
        ...
        Skill(
            ...
            baseDescription: "Helps users discover and install agent skills from shared skill directories.",
            baseDescriptionLocale: "en",
            localizedDescription: nil,
        ...
        Skill(
            ...
            baseDescription: "Start a new development phase by creating a spec file and setting context for the session.",
            baseDescriptionLocale: "en",
            localizedDescription: nil,
            source: .local,
            version: nil,
