...
function buildSummaryState(skillID: string, baseDescription: string | undefined): Pick<DiscoverSkill, 'baseDescription' | 'baseDescriptionLocale' | 'localizedDescription' | 'summary' | 'isDescriptionTranslated'> {
